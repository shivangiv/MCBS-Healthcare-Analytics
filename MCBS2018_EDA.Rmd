...
na<-function(v,df){
  x=(length(which(v==99))/nrow(fall18))
   if(x<0.01&x!=0){
     df<-df[df$v!=99,]
   }
...
na<-function(v){
   return ((length(which(v==99))/nrow(fall18))>0.01)
}


for(i in 1:length(fall18)){
    fall18<-fall18%>%subset(subset=na(fall18[i]))
}
(length(which(fall18$ADM_OP_MDCD==99))/nrow(fall18))

#Removing NAs from variables of interest if %NA is small


sum(fall18$ACC_HCTROUBL==99)/nrow(fall18)
sum(fall18$ACC_HCTRBMNY==99)/nrow(fall18)
sum(fall18$ACC_PAYPROB==99)/nrow(fall18)
sum(fall18$ACC_PAYOVRTM==99)/nrow(fall18)
sum(fall18$DEM_EDU==99)/nrow(fall18)
sum(fall18$ACC_PMNOTGET==99)/nrow(fall18)
