...
### Creating a variable to flag whether the person experiences costburden
...
fall18<-fall18%>%mutate(costburden=case_when(ACC_HCDELAY==1&ACC_PAYPROB==1~1,
                                             ACC_HCDELAY==1&ACC_PAYPROB==2~2,
                                             ACC_HCDELAY==2&ACC_PAYPROB==1~3,
                                            xor(fall18[49]==1,fall18[50]==1)~4, 
                                             ACC_HCDELAY!=1&ACC_PAYPROB!=1~5,
                                             TRUE~99
                                   ))

# fall18$costburden<-ifelse(fall18[49]==1&fall18[50]==1,1,
#                    ifelse(fall18[49]==1&fall18[50]==2,2,
#                    ifelse(fall18[49]==2&fall18[50]==1,3,
#                    ifelse(xor(fall18[49]==1,fall18[50]==1),4,
#                    ifelse(fall18[49]==2&fall18[50]==2,5,99)
#                    ))))
  


table(fall18$costburden)
```
...
unique(fall18_reformatted$DEM_IPR_IND)
unique(fall18$DEM_IPR_IND)
